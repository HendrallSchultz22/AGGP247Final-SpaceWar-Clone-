...
namespace LineDraw
{
    public static class LinePrimatives
    {
        ...
        public static bool SameTriangleSide(Vector2 P1, Vector2 P2, Vector2 A, Vector2 B)
        {
        ...
        public static bool IsInTriangle(Vector2 P, Vector2 Ta, Vector2 Tb, Vector2 Tc)
        {
            if(SameTriangleSide(P, Ta, Tb, Tc) && SameTriangleSide(P, Tb, Ta, Tc) && SameTriangleSide(P, Tc, Ta, Tb))
            {
                return true;
            }
            else
